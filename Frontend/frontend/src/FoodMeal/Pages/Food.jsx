                    ...
                    <p className="card-text mb-0">
                      <div className="mt-3">
                        ...
                        <p className="card-text mb-0">
                          ...
                          {grams[food.foodId]
                            ? (
                                (food.caloriesPer100g * grams[food.foodId]) /
                                100
                              ).toFixed(1)
                          ...
                          {grams[food.foodId]
                            ? (
                                (food.proteinPer100g * grams[food.foodId]) /
                                100
                              ).toFixed(1)
                            : food.proteinPer100g}{" "}
                          g
                          ...
                          {grams[food.foodId]
                            ? (
                                (food.carbsPer100g * grams[food.foodId]) /
                                100
                              ).toFixed(1)
                            : food.carbsPer100g}{" "}
                          g
                          ...
                          {grams[food.foodId]
                            ? (
                                (food.fatPer100g * grams[food.foodId]) /
                                100
                              ).toFixed(1)
                            : food.fatPer100g}{" "}
                          g
